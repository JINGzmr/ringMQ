...
var zkServer_OperationsServiceInfo = NewServiceInfo()

func NewServiceInfo() *kitex.ServiceInfo {
	serviceName := "ZkServer_Operations"
	handlerType := (*api.ZkServer_Operations)(nil)
	methods := map[string]kitex.MethodInfo{
		"Sub":               kitex.NewMethodInfo(subHandler, newZkServer_OperationsSubArgs, newZkServer_OperationsSubResult, false),
		"CreateTopic":       kitex.NewMethodInfo(createTopicHandler, newZkServer_OperationsCreateTopicArgs, newZkServer_OperationsCreateTopicResult, false),
		"CreatePart":        kitex.NewMethodInfo(createPartHandler, newZkServer_OperationsCreatePartArgs, newZkServer_OperationsCreatePartResult, false),
		"ProGetBroker":      kitex.NewMethodInfo(proGetBrokerHandler, newZkServer_OperationsProGetBrokerArgs, newZkServer_OperationsProGetBrokerResult, false),
		"SetPartitionState": kitex.NewMethodInfo(setPartitionStateHandler, newZkServer_OperationsSetPartitionStateArgs, newZkServer_OperationsSetPartitionStateResult, false),
		"ConStartGetBroker": kitex.NewMethodInfo(conStartGetBrokerHandler, newZkServer_OperationsConStartGetBrokerArgs, newZkServer_OperationsConStartGetBrokerResult, false),
		"BroInfo":           kitex.NewMethodInfo(broInfoHandler, newZkServer_OperationsBroInfoArgs, newZkServer_OperationsBroInfoResult, false),
		"UpdatePTPOffset":   kitex.NewMethodInfo(updatePTPOffsetHandler, newZkServer_OperationsUpdatePTPOffsetArgs, newZkServer_OperationsUpdatePTPOffsetResult, false),
		"UpdateDup":         kitex.NewMethodInfo(updateDupHandler, newZkServer_OperationsUpdateDupArgs, newZkServer_OperationsUpdateDupResult, false),
		"BecomeLeader":      kitex.NewMethodInfo(becomeLeaderHandler, newZkServer_OperationsBecomeLeaderArgs, newZkServer_OperationsBecomeLeaderResult, false),
		"GetNewLeader":      kitex.NewMethodInfo(getNewLeaderHandler, newZkServer_OperationsGetNewLeaderArgs, newZkServer_OperationsGetNewLeaderResult, false),
		"BroGetConfig":      kitex.NewMethodInfo(broGetConfigHandler, newZkServer_OperationsBroGetConfigArgs, newZkServer_OperationsBroGetConfigResult, false),
	}
